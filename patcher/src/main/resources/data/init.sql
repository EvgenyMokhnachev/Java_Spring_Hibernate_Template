...
CREATE TABLE project.notes (
  ...
  message    TEXT,
  date       BIGINT,
  assignedAllUsers     BOOLEAN
);

CREATE TABLE project.assigned_notes (
  note_id BIGINT,
  user_id BIGINT
);
...
CREATE TABLE audio.comments (
  ...
  audio_id       BIGSERIAL,
  author_id      BIGSERIAL,
  audio_file_id  BIGSERIAL,
  audio_json_file_id BIGSERIAL,
  date           BIGINT,
  resolved       BOOLEAN,
...
ALTER TABLE project.assigned_notes
ADD CONSTRAINT assigned_user_note_fk
FOREIGN KEY (note_id)
REFERENCES project.notes
ON DELETE CASCADE;

ALTER TABLE project.assigned_notes
ADD CONSTRAINT assigned_note_user_fk
FOREIGN KEY (user_id)
REFERENCES users.users
ON DELETE CASCADE;
